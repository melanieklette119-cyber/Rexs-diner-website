...
type Contract = { id: string; status: string; full_name: string; created_at: string; cancellation_requested_at?: string; minimum_end_at: string; next_charge_at: string; is_lifetime?: boolean; membership_plans?: Plan }
